...
<body>
	...
	<div class="container">
		<div class="row justify-content-center mt-5">
			<h1>
				<i class="fa fa-envelope-square"></i><span class="emailname">회원님의 아이디가 이메일로 전송되었습니다.</span>
			</h1>
		</div>
	</div>
	<div class="row justify-content-center mt-5">
		<div class="jumbotron shadow rounded">
			<div>
				<span class="contents-name">${dto.username}님!</span><strong class="welcome">회원님의 아이디가 이메일로 전송되었습니다.</strong>
				<p>안녕하세요. ${dto.username} 회원님!</p>
				<p>아래의 회원정보를 확인해 보시고 이메일(${dto.email})을 통해 아이디를 확인하시기 바랍니다.</p>
