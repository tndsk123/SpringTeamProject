...
<body>
	...
	<div class="container">
		<div class="row justify-content-center mt-5">
			<h1>
				<i class="fa fa-envelope-square"></i><span class="emailname">이메일
					인증</span><span class="emailsecondname">을 진행해주세요.</span>
			</h1>
		</div>
	</div>
	<div class="row justify-content-center mt-5">
		<div class="jumbotron shadow rounded">
			<div>
				<span class="contents-name">${dto.userid}님!</span><strong class="welcome">IF
					you 회원이 되신걸 환영합니다!</strong>
				<p>안녕하세요. ${dto.userid} 회원님!</p>
				<p>아래의 회원정보를 확인해 보시고 이메일(${dto.email}) 인증을 통해 회원가입을 완료하시기 바랍니다.</p>
